...
function ProfileInfo() {
  ...
  const userView = () => {
    return (
      ...
      <ViewUserProfile updateProfileClick={showUpdateProfile} user={user} setUser={setUser}/>
        ...
        <Card className='mt-2 border-0 rounded-0 shadow-sm'>
          <CardBody>
            ...
            <Container className='text-center'>
              <img style={{ maxWidth: '200px', maxHeight: '200px' }} src={`/images/${user.avatarUrl}`} alt="user profile picture" className='img-fluid  rounded-circle' />
            </Container>
